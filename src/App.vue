...
<script>
import TheHeader from "@/includes/TheHeader";
import TheFooter from "@/includes/TheFooter";
...
export default {
  ...
  methods:{
     ...
     recieveStoredLanguage(){
         this.$store.state.translateLang = localStorage.getItem('storedLang');
     }
  },

  created() {
    this.recieveStoredLanguage();
    this.getBlogs();
  },
};
</script>
